...
function post_latest(M) {
  ...
  for (var I = 0; I < posts_no; I++) {
    ...
    x[1] = "Jan", x[2] = "Feb", x[3] = "Mar", x[4] = "Apr", x[5] = "May", x[6] = "Jun", x[7] = "Jul", x[8] = "Aug", x[9] = "Sep", x[10] = "Oct", x[11] = "Nov", x[12] = "Des",
      document.write('<li class="last-post-item">'), document.write('<div class="post_item"><a href="' + j + '" target ="_top">' + E + "</a></div>"), 1 == post_rilis && document.write('<span class="post-update">' + x[parseInt(J, 10)] + " " + K + ", " + H + "</span>");
    var G = "",
      D = 0;
    document.write("</li>")
  }
